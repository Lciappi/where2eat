...
export default function GoogleMaps() {
  ...
  if (typeof window !== 'undefined' && !loaded.current) {
    if (!document.querySelector('#google-maps')) {
      loadScript(
        `https://maps.googleapis.com/maps/api/js?key=${GOOGLE_MAPS_API_KEY}&libraries=places&callback=getQuery`,
    ...
    <div>
      ...
      <Grid container spacing={6}>
        ...
        <Grid item textAlign='center' xs={6}>
          <Button fullWidth={true} variant="contained" onClick={sendRequest}>
            Eat!  
          </Button>
        </Grid>
        <Grid item xs={3}/>
